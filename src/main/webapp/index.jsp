...
<body>
	...
	<form method="post" action="Insert">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" placeholder="Phone Number" name="inputPhone" class="form-control" required>
			</div>
		</div>
		<div class="form-group row">
			<label for="inputEmail" class="col-sm-2 col-form-label">Email:</label>
			<div class="col-sm-10">
				<input type="text" placeholder="Email Address" name="inputEmail" class="form-control" required>
			</div>
		</div>	
		<div class="form-group row">
